...
type Props = NativeStackScreenProps<DiscoverStackParamList, 'Recommendations'>;
...
function RecommendationsContent({ navigation }: Props) {
  const {
    places,
    loading,
    refreshing,
  ...
  useEffect(() => {
    getRecommendedPlaces();
  }, [sortBy, filters, getRecommendedPlaces]);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Typography variant="h4" style={styles.title}>Recommended For You</Typography>
